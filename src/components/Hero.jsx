  ...
  return (
    <div className="min-h-screen bg-background text-white relative overflow-hidden">
      ...
      <div className='min-h-[calc(100vh-5rem)] flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 md:px-16 lg:px-0 pt-8 lg:pt-0'>
          ...
          {/* Hero Content */}
        <div className="relative z-10 flex flex-col items-center lg:items-start justify-start gap-6 lg:gap-10 lg:pl-32 flex-1 order-2 lg:order-1 text-center lg:text-left">
        ...
        <div className="relative z-10 flex-1 w-full h-64 sm:h-80 md:h-96 lg:h-full flex items-center justify-center order-1 lg:order-2 mb-8 lg:mb-0">
          <img 
            src={hero} 
            alt="hero image" 
